...
def get_backbone_cls(config: Gr00tN1d7Config):
    if ("nvidia/Cosmos-Reason2" in config.model_name or "/root/models--nvidia--Cosmos-Reason2-2B" in config.model_name
        or "Qwen/Qwen3-VL" in config.model_name or "models--Qwen--Qwen3-VL-2B-Instruct" in config.model_name):
